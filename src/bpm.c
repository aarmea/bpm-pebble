...
static bpm10_t s_bpm = BPM_DEFAULT_BPM_T;
static char s_bpm_text_buffer[BPM_TEXT_BUFFER_SIZE] = "";
...
void bpm_update_text_buffer() {
  if (s_bpm == 0)
    strncpy(s_bpm_text_buffer, BPM_TEXT_INVALID, BPM_TEXT_BUFFER_SIZE);
  else
